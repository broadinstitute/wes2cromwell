...
case class CromwellCallsMetadata(shardIndex: Option[Int],
...
case class CromwellSubmittedFiles(workflow: Option[String],
                                  workflowType: String,
...
case class CromwellMetadata(workflowName: Option[String],
                            id: String,
                            status: String,
                            start: Option[String],
                            end: Option[String],
